...
class _CityDetailsState extends State<CityDetails> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Consumer<CitiesModel>(builder: (context, citiesModel, _) {
                    ...
                    children: <Widget>[
                        ...
                        child: Row(
                          children: <Widget>[
                            ...
                            Padding(
                              ...
                              child: Image.asset(
                                citiesModel
                                    .citiesAvailable[widget.city].iconFlag,
                                scale: 1.5,
                              ),
                            ),
                          ],
                      ...
                      Container(
                        ...
                        child: PageView.builder(
                          ...
                          itemCount: citiesModel
                                  .citiesAvailable[widget.city].images.length -
                              1,
                          itemBuilder: (BuildContext context, index) {
                            return _imageSelector(
                                index: index + 1,
                                imagesList: citiesModel
                                    .citiesAvailable[widget.city].images);
                          },
                        ),
                      ),
                      Container(
                      ...
                      ListView.builder(
                        ...
                        itemCount: citiesModel
                            .citiesAvailable[widget.city].tours.length,
                        itemBuilder: (context, index) {
                          final tours = citiesModel
                              .citiesAvailable[this.widget.city].tours;
                      ...
                      ListView.separated(
                        ...
                        physics: const NeverScrollableScrollPhysics(),
                        itemCount: citiesModel
                            .citiesAvailable[widget.city].reviews.length,
                        itemBuilder: (context, index) {
                          final reviews = citiesModel
                              .citiesAvailable[this.widget.city].reviews;
